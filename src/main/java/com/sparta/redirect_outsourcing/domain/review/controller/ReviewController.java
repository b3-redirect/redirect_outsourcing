...
public class ReviewController {
    ...
    public ResponseEntity<DataResponseDto<ReviewResponseDto>> updateReview(
            ...
            @AuthenticationPrincipal UserDetailsImpl userDetails){
        ReviewResponseDto responseDto = reviewService.updateReview(requestDto,reviewId,userDetails.getUser());
    ...
    public ResponseEntity<DataResponseDto<List<ReviewResponseDto>>>getReviewList(@PathVariable Long restaurantId){
